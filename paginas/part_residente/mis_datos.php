...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $actualizar = "UPDATE datos_residente SET 
                    nombre = '$nombre',
                    apellido = '$apellido',
                    dni = '$dni',
                    correo = '$correo',
...
$consulta = "SELECT nombre, apellido, dni, correo, telefono, casa FROM datos_residente WHERE id = '$id'";
...
<body>
    <div class="container">
        ...
        <form method="post" action="mis_datos.php">
            ...
            <label>Casa:
                <input type="text" name="casa" value="<?= htmlspecialchars($datos['casa']) ?>" required>
            </label>

            <button class="guardar_cambios" type="submit">💾 Guardar cambios</button>
        </form>

        <a href="residente.php" class="volver-inicio">⬅ Volver al inicio</a>
